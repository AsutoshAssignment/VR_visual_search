...
from transformers import (
    Blip2Processor,                   # FIX 1: was BlipProcessor
    Blip2ForConditionalGeneration,    # FIX 1: was BlipForConditionalGeneration
    BlipProcessor,
...
@st.cache_resource(show_spinner="Loading BLIP-2 captioning model…")
...
def generate_caption(
    ...
    # BLIP-2 inputs must match model dtype on CUDA
    if DEVICE == "cuda":
